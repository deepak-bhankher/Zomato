      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 text-center lg:text-left mb-12">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li>
              <a href="https://www.zomato.com/" className="hover:text-white">
                Zomato
              </a>
            </li>
            <li>
              <a href="https://blinkit.com/" className="hover:text-white">
                Blinkit
              </a>
            </li>
            <li>
              <a href="https://www.district.in/" className="hover:text-white">
                District
              </a>
            </li>
            <li>
              <a href="https://www.hyperpure.com/" className="hover:text-white">
                Hyperpure
              </a>
            </li>
            <li>
            ...
            <li>
              <a
                href="https://www.eternal.com/investor-relations/"
                className="hover:text-white"
              >
                Investor India
              </a>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li>
              <a
                href="https://play.google.com/store/apps/details?id=com.application.services.partner"
                className="hover:text-white"
              >
                Apps For You
              </a>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="https://www.apple.com/in/app-store/">
              <img
                src="app_store.png"
                alt="app_store"
                className="h-10 w-32 hover:scale-105 transition"
              />
            </a>
